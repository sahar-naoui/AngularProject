...
@Component({
  selector: 'app-edit-delivery-challans',
  templateUrl: './edit-delivery-challans.component.html',
  styleUrls: ['./edit-delivery-challans.component.scss'],
})
export class EditDeliveryChallansComponent implements OnInit {
