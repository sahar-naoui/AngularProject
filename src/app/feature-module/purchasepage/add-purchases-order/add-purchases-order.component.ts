...
@Component({
  selector: 'app-add-purchases-order',
  templateUrl: './add-purchases-order.component.html',
  styleUrls: ['./add-purchases-order.component.scss'],
})
export class AddPurchasesOrderComponent implements OnInit {
  myDateValue!: Date;
  public minDate!: Date;
  public maxDate!: Date;
