...
@Component({
  selector: 'app-recurring-overdue',
  templateUrl: './recurring-overdue.component.html',
  styleUrls: ['./recurring-overdue.component.scss'],
})
export class RecurringOverdueComponent {
  ...
  constructor(
    ...
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.recurringoverdue) {
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.recurringOverdue().subscribe((apiRes: apiResultFormat) => {
